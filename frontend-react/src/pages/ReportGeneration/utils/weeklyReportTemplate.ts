/**
 * 周报HTML模板工具
 * 基于旧版 WeeklyReportTemplate.js 复刻
 *
 * 功能：
 * - 生成周报 HTML（完全参考原模板样式）
 * - 支持可编辑内容
 ...
 * 获取周次序数（中文）
 */
function getWeekOrdinal(weekNum: number): string {
  const ordinals = [
    '一', '二', '三', '四', '五', '六', '七', '八', '九', '十',
  ...
  return ordinals[weekNum - 1] || String(weekNum);
}
...
<body>
    <div class="editorial-container">
        ...
        <header class="masthead">
            ...
            <div class="dateline" contenteditable="true">${data.report_name || ''} · ${data.date_range || ''}</div>
        </header>
                ...
                <div class="source-body">
                    <div class="data-row">
                        ...
                        <span class="data-value">
                            <span class="editable-num" contenteditable="true">${formatNumber(data.content_count)}</span>
                            <span class="data-cum" contenteditable="true">/${formatNumber(data.content_count_cumulative)}</span>
                        </span>
                    </div>
                    <div class="data-row">
                        <span class="data-label" contenteditable="true">阅读播放</span>
                        <span class="data-value">
                            <span class="editable-num" contenteditable="true">${formatLargeNumber(data.content_views)}</span>
                            <span class="data-cum" contenteditable="true">/${formatLargeNumber(data.content_views_cumulative)}</span>
                        </span>
                    </div>
                </div>
            </div>
            ...
            <div class="layer-card" style="margin-bottom: 0;">
                ...
                <div class="source-body">
                    <div class="data-row">
                        ...
                        <span class="data-value">
                            <span class="editable-num" contenteditable="true">${formatNumber(data.live_sessions)}</span>
                            <span class="data-cum" contenteditable="true">/${formatNumber(data.live_sessions_cumulative)}场</span>
                        </span>
                    </div>
                    <div class="data-row">
                        <span class="data-label" contenteditable="true">观看人数</span>
                        <span class="data-value brand">
                            <span class="editable-num" contenteditable="true">${formatLargeNumber(data.live_viewers)}</span>
                            <span class="data-cum" contenteditable="true">/${formatLargeNumber(data.live_viewers_cumulative)}</span>
                        </span>
                    </div>
                </div>
            </div>
        ...
        <div class="layer-card ads-layer">
            ...
            <div class="ads-body">
                <div class="data-row" style="border-bottom: none; padding-bottom: 0;">
                    ...
                    <span class="data-value">
                        <span class="editable-num" contenteditable="true">${formatLargeNumber(data.ad_impressions)}</span>
                        <span class="data-cum" contenteditable="true">/${formatLargeNumber(data.ad_impressions_cumulative)}</span>
                    </span>
                </div>
                <div class="data-row" style="border-bottom: none; padding-bottom: 0;">
                    <span class="data-label" contenteditable="true">点击量</span>
                    <span class="data-value brand">
                        <span class="editable-num" contenteditable="true">${formatLargeNumber(data.ad_clicks)}</span>
                        <span class="data-cum" contenteditable="true">/${formatLargeNumber(data.ad_clicks_cumulative)}</span>
                    </span>
                </div>
            </div>
        </div>
        ...
        <div class="layer-card conversion-layer">
            ...
            <div class="conversion-body">
                <div class="conv-primary">
                    ...
                    <div class="conv-big-number" contenteditable="true">${formatNumber(data.new_accounts)}</div>
                    <div class="conv-big-cum" contenteditable="true">年度累计 ${formatNumber(data.new_accounts_cumulative)}</div>
                </div>
                    ...
                    <div class="conv-small-item">
                        ...
                        <div>
                            <span class="conv-small-value">
                                <span class="editable-num" contenteditable="true">${formatNumber(data.enterprise_wechat_add)}</span>
                                <span class="conv-small-cum" contenteditable="true">/${formatNumber(data.enterprise_wechat_add_cumulative)}</span>
                            </span>
                        </div>
                    </div>
                    <div class="conv-small-item">
                        ...
                        <div>
                            <span class="conv-small-value">
                                <span class="editable-num" contenteditable="true">${formatNumber(data.subscription_count)}</span>
                                <span class="conv-small-cum" contenteditable="true">/${formatNumber(data.subscription_count_cumulative)}</span>
                            </span>
                        </div>
                    </div>
                    <div class="conv-small-item">
                        ...
                        <div>
                            <span class="conv-small-value brand">
                                <span class="editable-num" contenteditable="true">${formatNumber(data.branch_new_accounts)}</span>
                                <span class="conv-small-cum" contenteditable="true">/${formatNumber(data.branch_new_accounts_cumulative)}</span>
                            </span>
                        </div>
                    </div>
                </div>
        ...
        <footer class="footer">
            ...
            <span class="pg-num" contenteditable="true">${getWeekOrdinal(data.report_week || 1)}期</span>
        </footer>
    </div>
</body>
</html>
