...
import { CloudUploadOutlined, ReloadOutlined, DeleteOutlined, CloudDownloadOutlined, WifiOutlined, SettingOutlined, ApiOutlined } from '@ant-design/icons';
import BackupProgress from './components/BackupProgress';
import VersionUpdateModal from './components/VersionUpdateModal';
import TableSyncCard from './components/TableSyncCard';
import { http } from '@/services/http';
import { dataServiceWebdav, type WebdavSyncStatus, type WebdavConfig } from '@/services/dataService';
import type {
  WebdavBackupFile,
...
const DatabaseBackupPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    loadSyncStatus();
    loadWebdavConfig();
  }, [loadBackupList, checkVersion, loadSyncStatus, loadWebdavConfig]);
