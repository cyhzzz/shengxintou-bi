...
def get_dashboard_core_metrics():
    ...
    try:
        ...
        # customer_contribution 需要从 BackendConversions 表单独查询
        # 暂时设为0，后续需要添加查询逻辑
        ...
        prev_existing_customers_assets = float(prev_result.existing_customer_assets) if prev_result.existing_customer_assets else 0
        # customer_contribution 需要从 BackendConversions 表单独查询
        prev_customer_contribution = 0
