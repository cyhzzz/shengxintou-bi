...
# v4.4.4: 应用市场 · A股成交金额（自主从东方财富获取，无需上传）
from backend.routes.reports import app_market_ashare as app_market_ashare_blueprint
...
# v4.4.4: 应用市场 · A股成交金额（自主从东方财富获取）
app.register_blueprint(app_market_ashare_blueprint.bp)
